...
export default function Dashboard() {
  const { shieldsData, spiritAshesData, talismansData } = useAppSelector(
  ...
  const generalTotal =
    shieldsStats.total + spiritAshesStats.total + talismansStats.total;
