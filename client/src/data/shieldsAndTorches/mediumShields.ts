...
export const mediumShields: ShieldOrTorchItem[] = [
  {
...

  {
    ...
    vendor: null,
    placementDescription:
      "Found in StormveilCastle in a room behind a Stonesword Key near Grafted Scion.", */
  },

  {
    ...
    placementDescription:
      "Purchased from Patches in Murkwater Cave (Limgrave) for 1000Runes.", */
  },
  ...
  },
  {
    ...
    placementDescription:
      "Starting equipment for Vagabond class; also purchased at Roundtable Hold for 1500 Runes.", */
  },
  {
    type: "shieldsAndTorches",
    subcategory: "mediumShields",
    ...
    placementDescription:
      "Starting shield for Confessor class; available from merchant near Bellum Church for 1500 Runes.", */
  },
  {
    type: "shieldsAndTorches",
    subcategory: "mediumShields",
    ...
    placementDescription:
      "Available for purchase from Nomadic Merchant (Liurnia) for ~2500 Runes.", */
  },
  {
    type: "shieldsAndTorches",
    subcategory: "mediumShields",
  ...
  },
  {
    ...
    placementDescription:
      "Bow-able from Nomadic Merchant by Liurnia Lake Shore for about 1000Runes.", */
  },
  {
    type: "shieldsAndTorches",
    subcategory: "mediumShields",
    ...
    placementDescription:
      "Purchased early from merchant near Fort Haight for 1000Runes.", */
  },
  {
    type: "shieldsAndTorches",
    subcategory: "mediumShields",
